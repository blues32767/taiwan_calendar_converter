...
"給予AI的題詞"
-----
當我寫的年份只有3位數的時候，則自動配對為民國年，
如果我給你115年2月25日，請幫我把年月日轉為"/"，變成115/2/25
例如：115年2月25日，則為 民國 115/2/25。

請幫我確認以下日期的星期是否正確：
1. 請使用perpetual calendar（萬年曆）驗證
2. 請同時列出西元年份對照
3. 請說明你的驗證過程
4. 如果有錯誤，請明確指出需要修正的部分
--------
...
### 快速使用方式
1. **直接使用現有資料**：
   - 2024-2050合併版(民國113-139年)-taiwan_calendar
   - 格式包含 CSV 和 TXT 兩種版本
   - 可直接導入系統使用，無需重新執行程式
